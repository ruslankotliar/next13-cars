...
export function DetailsComponent({ car }: { car: CarDocument }) {
  return (
    <div className="transition-transform transform hover:scale-105">
      <div className="relative h-52 w-full overflow-hidden rounded-lg shadow-md group">
        ...
        <div className="absolute bottom-0 w-full p-4 bg-gradient-to-t from-black to-transparent group-hover:bg-opacity-60">
          <h3 className="text-white text-xl font-semibold mb-2">{`${car.brand} ${car.model}`}</h3>
        </div>
      </div>
      <div className="mt-4">
        <div className="flex items-center space-x-2">
          <span className="text-gray-600 font-medium" data-editable="car-details-price">
            Price: $
          </span>
